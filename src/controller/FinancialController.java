...
public class FinancialController implements Initializable {
    @FXML
    private TextField idTxt, amountTxt, searchFTypeTxt;
    @FXML
    private TextArea descriptionTxt;
    @FXML
    private DatePicker dTimeDate;
    @FXML
    private ComboBox<String> fTypeCmb;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        saveBtn.setOnAction((event) ->{
            ...
            String message = save(
                    ...
                    dTimeDate.getValue().atStartOfDay(), //TODO چجوری میشه زمان رو هم از Date picker گرفت.
        ...
        searchFTypeTxt.setOnKeyReleased((event) -> {
            refreshTable(findByFType(searchFTypeTxt.getText()));
        });
